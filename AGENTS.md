# Agent Guide — ep_file_menu_toolbar

File / Menu style toolbar.
...
`ep_file_menu_toolbar` runs inside Etherpad's test harness. From an etherpad checkout that has installed this plugin via `pnpm run plugins i --path ../ep_file_menu_toolbar`:
...
* Server: `eejsBlock_body`, `eejsBlock_styles`
* Client: `postAceInit`
